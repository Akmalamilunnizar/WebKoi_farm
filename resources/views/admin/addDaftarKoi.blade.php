      ...
      <div class="card-body">
        ...
        <form action="{{ route('adddaftarkoi') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="name" name="name" rows="3" required></input>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#addJenisKoiModal">Add New</button>
              </div>
            </div>
          </div>
          ...
          <!-- <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="id_penyakit" name="id_penyakit" rows="3" placeholder = "Tulisan jenis penyakitnya jika sakit, jika sehat tuliskan -" required></textarea>
                </div>
              </div> -->
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#addPenyakitModal">Add New</button>
              </div>
            </div>
          </div>
          @if(session('error'))
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" id="description" name="description" rows="3" value="{{ old('description') }}" placeholder="Tuliskan keterangan terkait koi dan penyakit jika sakit" required></textarea>
            </div>
          </div>
